    ...
    <div class="container">
        <div class="single-grids">
            ...
            <div class="col-md-4 single-grid simpleCart_shelfItem">
                <h3>${g.name}</h3>
                <div class="tag">
                    <p>分类 : <a href="goods.action?typeid=5">${g.type_id.name}</a></p>
                </div>
                <p>${g.intro}</p>
                <div class="galry">
                    <div class="prices">
            ...
            <div class="col-md-4 single-grid1">
                <!-- <h2>商品分类</h2> -->
                <ul>
                    <li><a href="${pageContext.request.contextPath}/goods_list?id=0&pageNumber=1">全部商品</a></li>
                    <c:forEach items="${typeList}" var="t">
                        <li><a  href="${pageContext.request.contextPath}/goods_list?id=${t.id}&pageNumber=1">${t.name}</a></li>
                    </c:forEach>
                </ul>
            </div>
            <div class="clearfix"> </div>
...
<!--related-products--><!--
	<div class="related-products">
		<div class="container">
			<h3>猜你喜欢</h3>
			<div class="product-domain-sec single-product-grids">
